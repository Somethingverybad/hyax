  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-background to-primary/10 overflow-hidden">
      ...
      <div className="w-full h-screen overflow-y-auto scrollbar-custom">
        <div className="text-center max-w-2xl px-3 md:px-4 py-6 md:py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-12">
            ...
            <div className="p-4 md:p-6 rounded-xl md:rounded-2xl bg-gradient-card border border-border shadow-card hover:shadow-glow transition-all duration-300">
              ...
              <p className="text-xs md:text-sm text-muted-foreground">Мгновенная доставка в режиме реального времени</p>
            </div>
            ...
            <div className="p-4 md:p-6 rounded-xl md:rounded-2xl bg-gradient-card border border-border shadow-card hover:shadow-glow transition-all duration-300">
              ...
              <p className="text-xs md:text-sm text-muted-foreground">Отправляйте документы, изображения и другие файлы</p>
            </div>
          </div>
          ...
          <div className="mt-8 md:mt-12 space-y-3 md:space-y-6 opacity-70">
            ...
            <div className="p-3 md:p-4 rounded-lg bg-secondary/30 border border-border">
              <p className="text-xs md:text-sm text-muted-foreground">Работает на всех устройствах</p>
            </div>
            <div className="p-3 md:p-4 rounded-lg bg-secondary/30 border border-border">
              <p className="text-xs md:text-sm text-muted-foreground">Шифрование сообщений</p>
            </div>
          </div>
        </div>
      </div>
